...
<nav> → মেনু বা লিংক দেখানোর জায়গা
<nav>
  <a href="#">Home</a>
  <a href="#">About</a>
</nav>
<main> → ওয়েবপেজের মূল অংশ
<main>
  <h2>Main Content</h2>
</main>
<section> → পেজের আলাদা অংশ
<section>
  <h2>Section Title</h2>
</section>
<article> → নিজের মতো একটা লেখা বা পোস্ট

যা আলাদা করে পড়া যায়

<article>
  <h2>Article Title</h2>
  <p>This is an article content.</p>
</article>
<aside> → পাশের ছোট তথ্য বা extra অংশ

main content এর পাশে থাকে
...
📦 Special Tags
<address> → ঠিকানা বা contact info দেখানোর জন্য
<address>
  Email: example@gmail.com<br>
  Phone: 0123456789
</address>
<figure> → ছবি বা মিডিয়া একসাথে রাখার জন্য
<figure>
  <img src="image.jpg" alt="Image">
</figure>
<figcaption> → ছবির নিচে লেখা (ছবির নাম/ব্যাখ্যা)
<figure>
  <img src="image.jpg" alt="Image">
  <figcaption>এটি একটি ছবি</figcaption>
</figure>
<q> → ছোট কথা বা উদ্ধৃতি
<p>তিনি বললেন <q>HTML শেখা সহজ</q></p>
<mark> → গুরুত্বপূর্ণ লেখা highlight করে
<p>এটি <mark>important</mark> অংশ</p>
